// rapid api events for location search
function eventCity(city) {
    eventCityIndex = city;
   //return eventCityIndex;
}

let delhiEvent = document.getElementById("delhiEvent");
delhiEvent.addEventListener("click", () => eventCity("Delhi"));

// rapidAPI auto complete
